...
def most_common_interests_with(user):
    print("Users with most commom interest with user_id: %s" % user["id"])
    print("Legend to output: {user_id: interest_in_common}")
...
num_friends_by_id.sort(
    key=lambda user_id_x_num_friends: user_id_x_num_friends[1],
    reverse=True
)
...
print(most_common_interests_with(users[8]))
