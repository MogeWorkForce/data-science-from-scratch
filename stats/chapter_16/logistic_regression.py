...
from ..chapter_4.vectors import dot, vector_add
from ..chapter_8.gradient import maximize_batch, maximize_stochastic
from ..chapter_10.rescaling import rescale
from ..chapter_11.linear_regression import train_test_split
...
if __name__ == '__main__':
    data = [(0.7, 48000, 1), (1.9, 48000, 0), (2.5, 60000, 1),
            ...
            (1, 56000, 0), (6, 67000, 0), (4.9, 74000, 0), (6.4, 63000, 1),
            (6.2, 82000, 0), (3.3, 58000, 0), (9.3, 90000, 1),
            (5.5, 57000, 1), (9.1, 102000, 0), (2.4, 54000, 0),
            (8.2, 65000, 1), (5.3, 82000, 0), (9.8, 107000, 0),
            (1.8, 64000, 0), (0.6, 46000, 1), (0.8, 48000, 0),
            (8.6, 84000, 1), (0.6, 45000, 0), (0.5, 30000, 1),
            (7.3, 89000, 0), (2.5, 48000, 1), (5.6, 76000, 0),
            (7.4, 77000, 0), (2.7, 56000, 0), (0.7, 48000, 0),
            (1.2, 42000, 0), (0.2, 32000, 1), (4.7, 56000, 1),
            (2.8, 44000, 1), (7.6, 78000, 0), (1.1, 63000, 0),
            (8, 79000, 1), (2.7, 56000, 0), (6, 52000, 1), (4.6, 56000, 0),
            (2.5, 51000, 0), (5.7, 71000, 0), (2.9, 65000, 0),
            ...
            (2, 54000, 0), (1, 52000, 0), (4, 69000, 0), (6.5, 76000, 0),
            (3, 60000, 0), (4.5, 63000, 0), (7.8, 70000, 0),
            (3.9, 60000, 1), (0.8, 51000, 0), (4.2, 78000, 0),
            (1.1, 54000, 0), (6.2, 60000, 0), (2.9, 59000, 0),
            (2.1, 52000, 0), (8.2, 87000, 0), (4.8, 73000, 0),
            (2.2, 42000, 1), (9.1, 98000, 0), (6.5, 84000, 0),
            (6.9, 73000, 0), (5.1, 72000, 0), (9.1, 69000, 1),
            (9.8, 79000, 1), ]
    data = list(map(list, data))  # change tuples to lists

    x = [[1] + row[:2] for row in
         data]  # each element is [1, experience, salary]
    ...
    x_train, x_test, y_train, y_test = train_test_split(rescaled_x, y,
                                                        0.33)
    ...
    # Alternative way to calculate beta_hat with maximaze_stochastic
