...
from ..chapter_4.vectors import (
    dot, get_row, get_column, make_matrix, magnitude, scalar_multiply,
    shape, distance
)
...
def vector_as_matrix(v):
    ...
    Its looks like to me as transpose of some matrix 1 x n into n x 1"""
