...
from ..chapter_14.linear_regression import total_sum_of_squares
from ..chapter_4.vectors import dot, vector_add
from ..chapter_5.stats_formula import median, standard_deviation
from ..chapter_6.continuos_distribution import normal_cdf
from ..chapter_8.gradient import minimize_stochastic
...
if __name__ == "__main__":
    x = [[1, 49, 4, 0], [1, 41, 9, 0], [1, 40, 8, 0], [1, 25, 6, 0],
    ...
    daily_minutes_good = [68.77, 51.25, 52.08, 38.36, 44.54, 57.13, 51.4,
    ...
    print("Standard deviation", standard_deviation(close_to_100))
    print("Standard deviation", standard_deviation(far_from_100))

    random.seed(0)  # so that you get the same results as me
    data_zipped = list(zip(x, daily_minutes_good))
    bootstrap_betas = bootstrap_statistic(data_zipped,
    ...
    random.seed(0)
    beta_0 = estimate_beta_ridge(x, daily_minutes_good,
                                 alpha=0.0)  # [30.6, 0.97, -1.87, 0.91]
